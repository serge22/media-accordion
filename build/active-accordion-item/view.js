/******/ (() => { // webpackBootstrap
/*!*******************************************!*\
  !*** ./src/active-accordion-item/view.js ***!
  \*******************************************/
/**
...
document.addEventListener('DOMContentLoaded', function () {
  const accordions = document.querySelectorAll('.wp-block-srg-media-accordion');
  accordions.forEach(accordion => {
    const items = accordion.querySelectorAll('.wp-block-srg-media-accordion-item');
    if (items.length > 0) {
      let currentIndex = 0;
      let timeoutId = null;
      function showItem(index) {
        ...
        const duration = getComputedStyle(items[currentIndex]).getPropertyValue('--animation-duration');
